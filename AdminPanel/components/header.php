...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        <a href="index.php" class="navbar-brand mx-4 mb-3">
            <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>Vaccination</h3>
        </a>
        <div class="d-flex align-items-center ms-4 mb-4">
            <div class="position-relative">
                <img class="rounded-circle" src="img/user.jpg" alt="" style="width: 40px; height: 40px;">
    ...
    <h6 class="mb-0 ms-2">
        ...
        } elseif (isset($_SESSION['parentId'])) {
            echo $_SESSION['parentName'];
        } elseif (isset($_SESSION['hospitalId'])) {
            echo $_SESSION['hospitalName'];
        }
        ?>
    </h6>
    <div class="text-muted text-sm ms-2">
        <?php
        if (isset($_SESSION['adminId'])) {
            echo $_SESSION['adminEmail'];
        } elseif (isset($_SESSION['parentId'])) {
            echo $_SESSION['parentEmail'];
        } elseif (isset($_SESSION['hospitalId'])) {
            echo $_SESSION['hospitalEmail'];
        }
        ?>
    </div>
</div>
        ...
        <div class="navbar-nav w-100">
            ...
            <?php if(isset($_SESSION['Role']) && $_SESSION['Role'] == 1): ?>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="add-hospital.php" class="dropdown-item">Add Hospital</a>
