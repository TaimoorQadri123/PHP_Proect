                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="uName" value="<?php echo $userName?>" class="form-control" id="floatingText" placeholder="jhondoe">
                            <label for="floatingText">Usernam</label>
                            <small id="helpId" class="text-danger"><?php echo $userNameErr?></small>

                        </div>
                        <div class="form-floating mb-3">
                            <input type="email"  name="uEmail" value="<?php echo $userEmail?>" class="form-control" id="floatingInput" placeholder="name@example.com">
                        ...
                        <div class="form-floating mb-4">
                         ...
                         <div class="form-floating mb-4">
                            <input type="password" name="uConfirmPassword" value="<?php echo $userConfirmPassword?>" class="form-control" id="floatingPassword" placeholder="Password">
                        ...
                        <button name="registerUser" class="btn btn-primary py-3 w-100 mb-4">Sign Up</button>
